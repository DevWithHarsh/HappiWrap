...
export default function Login() {
    ...
    const handleSubmit = async (event: React.FormEvent) => {
        ...
        try {
            ...
            // Add a small delay before navigating, so toast has time to display
            setTimeout(() => {
                navigate('/giftchatbot'); // Navigate to the chat page
            }, 1500); // 1.5 seconds delay to show the toast before navigation
