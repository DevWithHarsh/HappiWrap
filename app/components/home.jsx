...
import { Gift, MessageCircle, ShoppingBag, ThumbsUp, UserPlus } from 'lucide-react'
            ...
            <main className="flex-grow container mx-auto px-4 py-16 z-10 space-y-24">
                <section className="text-center">
                    ...
                    <div className="flex justify-center space-x-4">
                        <Button className="bg-[#7E60BF] hover:bg-[#FFE1F0] hover:text-[#433878] text-[#FFE1FF] px-6 py-3 text-lg transition-all duration-300 transform hover:scale-105" onClick={() => navigate('/login')}>
