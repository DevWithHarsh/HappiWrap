...
export default function AuthPage() {
  ...
  const handleAuthSubmit = (event: React.FormEvent) => {
    ...
    navigate('/chat'); // Redirect to the chatbot page after successful auth
  };
              ...
              <form onSubmit={handleAuthSubmit}>
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input id="email" type="email" placeholder="m@example.com" required className="bg-white text-[#7E60BF]" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="password" className="text-[#7E60BF]">Password</Label>
                    <Input id="password" type="password" required className="bg-white text-[#7E60BF]" />
                  </div>
                </div>
              ...
              <form onSubmit={handleAuthSubmit}>
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input id="name" placeholder="John Doe" required className="bg-white text-[#7E60BF]" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="email" className="text-[#7E60BF]">Email</Label>
                    <Input id="email" type="email" placeholder="m@example.com" required className="bg-white text-[#7E60BF]" />
